# Energy Production, Consumption and CO2 Emission Analysis
## Introduction
...
3 datasets where used:: * Energy Production dataset - energy_production_total.csv.
Description: Energy production refers to forms of primary energy--petroleum (crude
oil, natural gas liquids, and oil from nonconventional sources), natural gas, solid fuels
(coal, lignite, and other derived fuels), and combustible renewables and waste--and
primary electricity, all converted into tonnes of oil equivalents.
>
...
>
• Energy Consumption dataset - 'energy_use_per_person.csv. Description: Energy use
refers to use of primary energy before transformation to other end-use fuels, which is equal
to indigenous production plus imports and stock changes, minus exports and fuels supplied
